  ...
  return (
    <div className="container mx-auto px-4 py-3 gap-6 flex flex-col">
      <div className="flex flex-col items-center gap-3 text-center lg:py-20  py-10 max-w-lg w-full mx-auto ">
        <h1 className="text-4xl font-medium text-center">Open-Source API Key Generator</h1>
        <p className="mb-2 text-center">
          Open-Source API key generation made simple. Build your own key generator system without the complexity.
        </p>
